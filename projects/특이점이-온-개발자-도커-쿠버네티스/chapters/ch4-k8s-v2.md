...
![클러스터 구조](images/ch4-overview-1a-cluster.png)
...
![워커 노드 내부](images/ch4-overview-1b-node.png)
...
![트래픽 경로](images/ch4-overview-2-flow.png)
...
![계층별 역할](images/ch4-overview-3-layers.png)
...
![NodePort](images/ch4-service-2-nodeport.png)
...
![ClusterIP](images/ch4-service-1-clusterip.png)
...
![LoadBalancer](images/ch4-service-3-loadbalancer.png)
