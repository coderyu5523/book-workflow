...
![프로비저닝](images/chap02-provisioning.png)
*그림 3-1: 수동 세팅과 프로비저닝*
...
![](images/ex01-host-routing-1.png)
...
![NGINX 내부 — location → upstream](images/upstream.png)
...
![host.docker.internal 우회 경로](images/net-04-host-routing.png)
...
![](images/ex01-host-routing-2.png)
...
![여러 컨테이너가 연동되는 웹 애플리케이션 아키텍처](images/fig-1-v2.png)
