...
<svg viewBox="0 0 680 350" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Deployment 안에 ReplicaSet이 있고 ReplicaSet 안에 Pod 두 개가 가로로 들어 있는 소유 구조. Deployment는 원하는 상태를 선언하고 ReplicaSet을 만들어 관리하며, ReplicaSet은 선언한 개수만큼 Pod를 유지하고, 각 Pod는 컨테이너를 실행한다">
  <text x="340" y="26" text-anchor="middle" font-size="15" font-weight="700" fill="#0f172a">챕터 4 한눈에 보기 — 전체 구조</text>
  <rect x="20" y="42" width="640" height="290" rx="12" fill="none" stroke="#475569" stroke-width="1.4" stroke-dasharray="6,4"/>
  <text x="34" y="62" font-size="11" font-weight="600" fill="#0f172a">Kubernetes 클러스터 (Minikube)</text>
  <rect x="48" y="80" width="584" height="234" rx="10" fill="#fff" stroke="#4f46e5" stroke-width="1.8"/>
  <text x="70" y="106" font-size="14" font-weight="700" fill="#3730a3">Deployment</text>
  <text x="70" y="124" font-size="10" fill="#6d28d9">원하는 상태를 선언하고, ReplicaSet을 만들어 관리</text>
  <text x="612" y="106" text-anchor="end" font-size="10" font-weight="700" fill="#4f46e5">챕터 4.4</text>
  <rect x="80" y="142" width="520" height="160" rx="8" fill="#fff" stroke="#4f46e5" stroke-width="1.5"/>
  <text x="102" y="168" font-size="13" font-weight="700" fill="#3730a3">ReplicaSet</text>
  <text x="102" y="184" font-size="10" fill="#4f46e5">선언한 개수만큼 Pod 유지</text>
  <text x="580" y="168" text-anchor="end" font-size="10" font-weight="700" fill="#4f46e5">챕터 4.4.3</text>
  <rect x="120" y="200" width="222" height="80" rx="6" fill="#fff4ed" stroke="#ff7849" stroke-width="1.6"/>
  <text x="231" y="226" text-anchor="middle" font-size="13" font-weight="700" fill="#7b341e">Pod 1</text>
  <text x="231" y="244" text-anchor="middle" font-size="10" fill="#7b341e">컨테이너 실행</text>
  <text x="231" y="262" text-anchor="middle" font-size="10" font-weight="700" fill="#ff7849">챕터 4.3</text>
  <rect x="360" y="200" width="222" height="80" rx="6" fill="#fff4ed" stroke="#ff7849" stroke-width="1.6"/>
  <text x="471" y="226" text-anchor="middle" font-size="13" font-weight="700" fill="#7b341e">Pod 2</text>
  <text x="471" y="244" text-anchor="middle" font-size="10" fill="#7b341e">컨테이너 실행</text>
  <text x="471" y="262" text-anchor="middle" font-size="10" font-weight="700" fill="#ff7849">챕터 4.3</text>
</svg>
</div>
...
본사는 가맹점을 직접 운영하지 않습니다. 대신 가맹점 수나 모습 같은 **규칙**을 정하고 그 규칙이 지켜지는지를 관리합니다. 만약 매장이 문을 닫으면 **새 매장을 다시 열어** 개수를 맞추고, 수요가 많아지면 **새로운 매장을 추가**합니다.
...
<svg viewBox="0 0 800 460" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="본사 빌딩이 가맹점 매장 4개를 유지하도록 선언하면 시스템이 자동으로 개수를 맞추는 구조">
  ...
  <text x="400" y="20" text-anchor="middle" font-size="12" font-weight="700" fill="#1f2937">본사가 "가맹점 3개"를 선언하면 시스템이 알아서 맞춥니다</text>
  <g>
    ...
    <text x="234" y="120" text-anchor="middle" font-size="11" fill="#1565c0" font-weight="700">"가맹점 3개 유지"</text>
  ...
  <g>
    ...
    <text x="680" y="436" text-anchor="middle" font-size="10" fill="#ff7849">자동 개점 (3개 회복)</text>
  </g>
...
<svg viewBox="0 0 940 400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Kubernetes 클러스터 구조 — 컨트롤 플레인 노드 1대와 워커 노드 2대가 각각 독립된 호스트 OS·하드웨어 위에서 동작">
  ...
  <text x="470" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#0f172a">Kubernetes 클러스터의 구조</text>
  <text x="22" y="163" font-size="10" font-weight="600" fill="#64748b" transform="rotate(-90 22 163)">오케스트레이션 계층</text>
  <text x="22" y="303" font-size="10" font-weight="600" fill="#64748b" transform="rotate(-90 22 303)">인프라 계층</text>
  <rect x="55" y="70" width="250" height="310" rx="8" fill="none" stroke="#ff7849" stroke-width="2"/>
  <path d="M 63 70 L 297 70 Q 305 70 305 78 L 305 98 L 55 98 L 55 78 Q 55 70 63 70 Z" fill="#ff7849"/>
  <text x="180" y="89" text-anchor="middle" font-size="13" font-weight="700" fill="#fff">컨트롤 플레인 노드</text>
  <rect x="72" y="108" width="216" height="110" rx="6" fill="none" stroke="#94a3b8" stroke-width="1.2" stroke-dasharray="5,3"/>
  <rect x="80" y="120" width="200" height="40" rx="4" fill="#fff" stroke="#ff7849" stroke-width="1.4"/>
  <text x="180" y="144" text-anchor="middle" font-size="13" font-weight="700" fill="#7b341e">Kube API Server</text>
  <rect x="80" y="176" width="58" height="30" rx="3" fill="#fff" stroke="#fcd4bf"/>
  <text x="109" y="195" text-anchor="middle" font-size="11" font-weight="600" fill="#7b341e">etcd</text>
  <rect x="146" y="176" width="72" height="30" rx="3" fill="#fff" stroke="#fcd4bf"/>
  <text x="182" y="195" text-anchor="middle" font-size="11" font-weight="600" fill="#7b341e">Scheduler</text>
  <rect x="226" y="176" width="54" height="30" rx="3" fill="#fff" stroke="#fcd4bf"/>
  <text x="253" y="189" text-anchor="middle" font-size="9" font-weight="600" fill="#7b341e">Controller</text>
  <text x="253" y="200" text-anchor="middle" font-size="9" font-weight="600" fill="#7b341e">Manager</text>
  <line x1="55" y1="230" x2="305" y2="230" stroke="#94a3b8" stroke-width="1.2" stroke-dasharray="6,4"/>
  <rect x="72" y="240" width="216" height="58" rx="4" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1.2"/>
  <text x="180" y="274" text-anchor="middle" font-size="12" font-weight="600" fill="#475569">호스트 OS</text>
  <rect x="72" y="308" width="216" height="58" rx="4" fill="#cbd5e1" stroke="#94a3b8" stroke-width="1.2"/>
  <text x="180" y="342" text-anchor="middle" font-size="12" font-weight="600" fill="#0f172a">하드웨어 (물리 서버 / VM)</text>
  <line x1="307" y1="225" x2="383" y2="225" stroke="#475569" stroke-width="2" marker-end="url(#k8s-cmd-ah)"/>
  <text x="345" y="216" text-anchor="middle" font-size="11" fill="#475569" font-weight="600" font-style="italic">명령</text>
  <rect x="385" y="70" width="250" height="310" rx="8" fill="none" stroke="#4f46e5" stroke-width="2"/>
  <path d="M 393 70 L 627 70 Q 635 70 635 78 L 635 98 L 385 98 L 385 78 Q 385 70 393 70 Z" fill="#4f46e5"/>
  <text x="510" y="89" text-anchor="middle" font-size="13" font-weight="700" fill="#fff">워커 노드 1</text>
  <rect x="402" y="108" width="216" height="110" rx="6" fill="none" stroke="#94a3b8" stroke-width="1.2" stroke-dasharray="5,3"/>
  <rect x="410" y="120" width="100" height="40" rx="4" fill="#fff" stroke="#4f46e5" stroke-width="1.4"/>
  <text x="460" y="144" text-anchor="middle" font-size="12" font-weight="700" fill="#3730a3">kubelet</text>
  <rect x="518" y="120" width="100" height="40" rx="4" fill="#fff" stroke="#4f46e5" stroke-width="1.4"/>
  <text x="568" y="144" text-anchor="middle" font-size="12" font-weight="700" fill="#3730a3">kube-proxy</text>
  <rect x="410" y="176" width="208" height="36" rx="4" fill="#eef2ff" stroke="#c7d2fe" stroke-width="1.4"/>
  <text x="514" y="199" text-anchor="middle" font-size="12" font-weight="700" fill="#3730a3">컨테이너 엔진</text>
  <line x1="385" y1="230" x2="635" y2="230" stroke="#94a3b8" stroke-width="1.2" stroke-dasharray="6,4"/>
  <rect x="402" y="240" width="216" height="58" rx="4" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1.2"/>
  <text x="510" y="274" text-anchor="middle" font-size="12" font-weight="600" fill="#475569">호스트 OS</text>
  <rect x="402" y="308" width="216" height="58" rx="4" fill="#cbd5e1" stroke="#94a3b8" stroke-width="1.2"/>
  <text x="510" y="342" text-anchor="middle" font-size="12" font-weight="600" fill="#0f172a">하드웨어 (물리 서버 / VM)</text>
  <rect x="660" y="70" width="250" height="310" rx="8" fill="none" stroke="#4f46e5" stroke-width="2"/>
  <path d="M 668 70 L 902 70 Q 910 70 910 78 L 910 98 L 660 98 L 660 78 Q 660 70 668 70 Z" fill="#4f46e5"/>
  <text x="785" y="89" text-anchor="middle" font-size="13" font-weight="700" fill="#fff">워커 노드 2</text>
  <rect x="677" y="108" width="216" height="110" rx="6" fill="none" stroke="#94a3b8" stroke-width="1.2" stroke-dasharray="5,3"/>
  <rect x="685" y="120" width="100" height="40" rx="4" fill="#fff" stroke="#4f46e5" stroke-width="1.4"/>
  <text x="735" y="144" text-anchor="middle" font-size="12" font-weight="700" fill="#3730a3">kubelet</text>
  <rect x="793" y="120" width="100" height="40" rx="4" fill="#fff" stroke="#4f46e5" stroke-width="1.4"/>
  <text x="843" y="144" text-anchor="middle" font-size="12" font-weight="700" fill="#3730a3">kube-proxy</text>
  <rect x="685" y="176" width="208" height="36" rx="4" fill="#eef2ff" stroke="#c7d2fe" stroke-width="1.4"/>
  <text x="789" y="199" text-anchor="middle" font-size="12" font-weight="700" fill="#3730a3">컨테이너 엔진</text>
  <line x1="660" y1="230" x2="910" y2="230" stroke="#94a3b8" stroke-width="1.2" stroke-dasharray="6,4"/>
  <rect x="677" y="240" width="216" height="58" rx="4" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1.2"/>
  <text x="785" y="274" text-anchor="middle" font-size="12" font-weight="600" fill="#475569">호스트 OS</text>
  <rect x="677" y="308" width="216" height="58" rx="4" fill="#cbd5e1" stroke="#94a3b8" stroke-width="1.2"/>
  <text x="785" y="342" text-anchor="middle" font-size="12" font-weight="600" fill="#0f172a">하드웨어 (물리 서버 / VM)</text>
</svg>
</div>
...
<svg viewBox="0 0 790 290" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="명령 단계 — 개발자가 클러스터에 명령을 보내 Kube API Server에 도달하는 길.">
  ...
  <text x="292" y="206" text-anchor="middle" font-size="16" font-weight="700" fill="#cbd5e1">etcd</text>
  <text x="292" y="228" text-anchor="middle" font-size="11" fill="#cbd5e1">기록실 — 상태 저장</text>
  <rect x="385" y="170" width="180" height="80" rx="6" fill="none" stroke="#cbd5e1" stroke-width="1.2" stroke-dasharray="4,3"/>
  <text x="475" y="206" text-anchor="middle" font-size="16" font-weight="700" fill="#cbd5e1">Scheduler</text>
  <text x="475" y="228" text-anchor="middle" font-size="11" fill="#cbd5e1">출점 담당팀 — 노드 선정</text>
  ...
  <circle cx="80" cy="100" r="12" fill="#fff" stroke="#475569" stroke-width="1.8"/>
...
<svg viewBox="85 0 790 290" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="판단 단계 — 컨트롤 플레인 안내데스크와 세 부서가 양방향으로 협의해 결론을 좁히는 모습.">
  ...
  <text x="292" y="206" text-anchor="middle" font-size="16" font-weight="700" fill="#7b341e">etcd</text>
  <text x="292" y="228" text-anchor="middle" font-size="11" fill="#7b341e">기록실 — 상태 저장</text>
  <rect x="385" y="170" width="180" height="80" rx="6" fill="#fff" stroke="#ff7849" stroke-width="1.6"/>
  <text x="475" y="206" text-anchor="middle" font-size="16" font-weight="700" fill="#7b341e">Scheduler</text>
  <text x="475" y="228" text-anchor="middle" font-size="11" fill="#7b341e">출점 담당팀 — 노드 선정</text>
...
**Kube API Server**는 들어온 요청을 바탕으로 **클러스터의 상태**를 업데이트하고, 이 정보를 **etcd**에 보관합니다. **Scheduler**는 보관된 정보를 확인해 새 Pod를 **어느 노드에 배치할지** 정합니다. 동시에 **Controller Manager**는 클러스터 상태가 **원래 설정된 모습대로 유지되고 있는지** 감시합니다.
...
<svg viewBox="0 0 880 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Kubernetes 핵심 리소스의 전체 구조 — 사용자 요청은 Service에서 Pod로 직접 흐르고, Pod 오른쪽의 Deployment가 Pod 생성·관리를 담당한다">
  ...
  <rect x="140" y="50" width="720" height="260" rx="10" fill="none" stroke="#475569" stroke-width="1.6" stroke-dasharray="6,4"/>
  <line x1="100" y1="155" x2="170" y2="155" stroke="#9ca3af" stroke-width="1.4" marker-end="url(#k4-g)"/>
...
<svg viewBox="0 0 760 380" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Minikube 단일 노드 안에 컨트롤 플레인 역할과 워커 노드 역할이 함께 들어 있고, 그 아래 가상화 환경, 호스트 OS, 하드웨어가 인프라 계층을 이룬다.">
  ...
  <text x="330" y="159" text-anchor="middle" font-size="8" font-weight="600" fill="#7b341e">Controller</text>
  <text x="330" y="168" text-anchor="middle" font-size="8" font-weight="600" fill="#7b341e">Manager</text>
...
**Pod(파드)는 하나 이상의 컨테이너로 구성된 단위**입니다. 쿠버네티스는 컨테이너를 하나씩 직접 다루지 않고, 이 Pod를 단위로 관리합니다.

<div class="svg-figure">
<svg viewBox="0 0 760 245" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Pod 안에 두 컨테이너(Container A·B)가 들어 있는 구조">
  <text x="380" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#0f172a">컨테이너를 감싸는 Pod</text>
...
Pod가 생성됐습니다. 이 방식은 `docker run`과 비슷한 방식입니다.

*'이건 명령형 방식이네. 그럼 선언형으로는 어떻게 만들까?'*

### 4.3.3 YAML로 Pod 만들기

선언형은 **원하는 상태**를 YAML 파일로 작성하여 클러스터에 반영하는 방식입니다. 명령어로 일일이 지시하는 대신, 쿠버네티스가 YAML을 읽어 원하는 상태로 리소스를 생성합니다.
...
```yaml [실습 1] ex08/hello-pod2.yml. nginx Pod 정의
apiVersion: v1
kind: Pod                 # 리소스 종류
metadata:
...
<div class="terminal-log">
  ...
  <div class="tl-body">
    <div><span class="tl-key">$</span> <span class="tl-str">kubectl delete pod hello-pod2</span></div>
    <div>pod "hello-pod2" deleted</div>
    <div><span class="tl-key">$</span> <span class="tl-str">kubectl get pod</span></div>
    <div>NAME         READY   STATUS    RESTARTS   AGE</div>
    <div>hello-pod1   1/1     Running   0          19m</div>
  </div>
</div>
...
<div class="svg-figure">
<svg viewBox="0 0 760 270" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Deployment 구조: Deployment가 원하는 상태를 선언해 두고 여러 Pod를 띄워 관리한다">
  <defs>
    <marker id="mng-arr" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto">
      <path d="M0,0 L0,6 L8,3 z" fill="#4f46e5"/>
    </marker>
  </defs>
  <text x="380" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#0f172a">Deployment의 구조 — Pod를 띄우고 원하는 상태를 계속 유지</text>
  <rect x="40" y="80" width="260" height="120" rx="8" fill="#fff" stroke="#4f46e5" stroke-width="1.8"/>
  <path d="M 48 80 L 292 80 Q 300 80 300 88 L 300 106 L 40 106 L 40 88 Q 40 80 48 80 Z" fill="#4f46e5"/>
  <text x="170" y="99" text-anchor="middle" font-size="13" font-weight="700" fill="#fff">Deployment</text>
  <text x="170" y="135" text-anchor="middle" font-size="12" fill="#3730a3">원하는 상태를 선언</text>
  <text x="170" y="160" text-anchor="middle" font-size="12" fill="#3730a3">↻ 비교·유지</text>
  <text x="170" y="186" text-anchor="middle" font-size="11" font-style="italic" fill="#64748b">(매뉴얼 역할)</text>
  <path d="M 300 130 Q 410 110, 510 90" fill="none" stroke="#4f46e5" stroke-width="1.8" stroke-dasharray="6,4" marker-end="url(#mng-arr)"/>
  <path d="M 300 150 Q 410 170, 510 190" fill="none" stroke="#4f46e5" stroke-width="1.8" stroke-dasharray="6,4" marker-end="url(#mng-arr)"/>
  <text x="405" y="135" text-anchor="middle" font-size="11" font-weight="700" fill="#4f46e5">관리</text>
  <rect x="510" y="60" width="220" height="60" rx="6" fill="#fff" stroke="#ff7849" stroke-width="1.6"/>
  <path d="M 516 60 L 724 60 Q 730 60 730 66 L 730 80 L 510 80 L 510 66 Q 510 60 516 60 Z" fill="#ff7849"/>
  <text x="620" y="74" text-anchor="middle" font-size="12" font-weight="700" fill="#fff">Pod 1</text>
  <text x="620" y="106" text-anchor="middle" font-size="11" font-style="italic" fill="#7b341e">실행 중</text>
  <rect x="510" y="160" width="220" height="60" rx="6" fill="#fff" stroke="#ff7849" stroke-width="1.6"/>
  <path d="M 516 160 L 724 160 Q 730 160 730 166 L 730 180 L 510 180 L 510 166 Q 510 160 516 160 Z" fill="#ff7849"/>
  <text x="620" y="174" text-anchor="middle" font-size="12" font-weight="700" fill="#fff">Pod 2</text>
  <text x="620" y="206" text-anchor="middle" font-size="11" font-style="italic" fill="#7b341e">실행 중</text>
  <text x="380" y="250" text-anchor="middle" font-size="11" font-style="italic" fill="#475569">Pod가 사라지면 Deployment가 같은 정의의 Pod를 다시 띄워 원래대로 맞춥니다.</text>
</svg>
</div>
...
```yaml [실습 2] ex09/deploy-ex01.yml. Deployment 정의 (replicas 1)
apiVersion: apps/v1
kind: Deployment
metadata:
  name: nginx-deploy
...
<svg viewBox="0 0 760 285" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Deployment의 selector(app: nginx)와 같은 라벨을 가진 Pod만 골라 관리하고, 라벨이 다른 Pod는 제외하는 구조">
  ...
  <text x="525" y="91" font-size="13" font-family="monospace" fill="#7b341e">labels:</text>
  <text x="585" y="91" font-size="13" font-family="monospace" font-weight="700" fill="#7b341e">app: nginx</text>
  ...
  <text x="525" y="176" font-size="13" font-family="monospace" fill="#7b341e">labels:</text>
  <text x="585" y="176" font-size="13" font-family="monospace" font-weight="700" fill="#7b341e">app: nginx</text>
  ...
  <text x="525" y="261" font-size="13" font-family="monospace" fill="#94a3b8">labels:</text>
  <text x="585" y="261" font-size="13" font-family="monospace" font-weight="700" fill="#94a3b8">app: db</text>
...
<div class="svg-figure">
<svg viewBox="0 0 760 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="ReplicaSet 자가 복구: Pod 하나가 종료되면 새 Pod를 자동으로 띄워 개수를 맞춘다">
  <defs>
    <marker id="rs-mng" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto">
      <path d="M0,0 L0,6 L8,3 z" fill="#4f46e5"/>
    </marker>
    <marker id="rs-dim" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto">
      <path d="M0,0 L0,6 L8,3 z" fill="#cbd5e1"/>
    </marker>
  </defs>
  <text x="380" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#0f172a">Pod 하나가 종료되면 새 Pod를 자동으로 띄워 개수를 맞춤</text>
  <rect x="40" y="105" width="260" height="120" rx="8" fill="#fff" stroke="#4f46e5" stroke-width="1.8"/>
  <path d="M 48 105 L 292 105 Q 300 105 300 113 L 300 131 L 40 131 L 40 113 Q 40 105 48 105 Z" fill="#4f46e5"/>
  <text x="170" y="124" text-anchor="middle" font-size="13" font-weight="700" fill="#fff">ReplicaSet</text>
  <text x="170" y="160" text-anchor="middle" font-size="12" fill="#3730a3">replicas: 2</text>
  <text x="170" y="185" text-anchor="middle" font-size="12" fill="#3730a3">↻ 비교·유지</text>
  <path d="M 300 145 Q 410 110, 510 80" fill="none" stroke="#4f46e5" stroke-width="1.8" stroke-dasharray="6,4" marker-end="url(#rs-mng)"/>
  <path d="M 300 165 Q 410 165, 510 165" fill="none" stroke="#cbd5e1" stroke-width="1.4" stroke-dasharray="4,3" marker-end="url(#rs-dim)"/>
  <path d="M 300 185 Q 410 220, 510 250" fill="none" stroke="#4f46e5" stroke-width="2.4" stroke-dasharray="6,4" marker-end="url(#rs-mng)"/>
  <text x="405" y="135" text-anchor="middle" font-size="11" font-weight="700" fill="#4f46e5">관리</text>
  <text x="405" y="245" text-anchor="middle" font-size="11" font-weight="700" fill="#4f46e5" font-style="italic">새로 띄움</text>
  <rect x="510" y="50" width="220" height="60" rx="6" fill="#fff" stroke="#ff7849" stroke-width="1.6"/>
  <path d="M 516 50 L 724 50 Q 730 50 730 56 L 730 70 L 510 70 L 510 56 Q 510 50 516 50 Z" fill="#ff7849"/>
  <text x="620" y="64" text-anchor="middle" font-size="12" font-weight="700" fill="#fff">Pod 1</text>
  <text x="620" y="96" text-anchor="middle" font-size="11" font-style="italic" fill="#7b341e">실행 중</text>
  <rect x="510" y="135" width="220" height="60" rx="6" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1.4" stroke-dasharray="4,3"/>
  <path d="M 516 135 L 724 135 Q 730 135 730 141 L 730 155 L 510 155 L 510 141 Q 510 135 516 135 Z" fill="#cbd5e1"/>
  <text x="620" y="149" text-anchor="middle" font-size="12" font-weight="700" fill="#fff" text-decoration="line-through">Pod 2</text>
  <text x="620" y="181" text-anchor="middle" font-size="11" font-style="italic" fill="#94a3b8">종료</text>
  <line x1="690" y1="142" x2="715" y2="167" stroke="#475569" stroke-width="2.5"/>
  <line x1="715" y1="142" x2="690" y2="167" stroke="#475569" stroke-width="2.5"/>
  <rect x="510" y="220" width="220" height="60" rx="6" fill="#fff4ed" stroke="#ff7849" stroke-width="2.4"/>
  <path d="M 516 220 L 724 220 Q 730 220 730 226 L 730 240 L 510 240 L 510 226 Q 510 220 516 220 Z" fill="#ff7849"/>
  <text x="620" y="234" text-anchor="middle" font-size="12" font-weight="700" fill="#fff">Pod 3</text>
  <text x="620" y="266" text-anchor="middle" font-size="11" font-style="italic" fill="#7b341e">자동 생성</text>
  <rect x="688" y="248" width="34" height="18" rx="3" fill="#4f46e5"/>
  <text x="705" y="261" text-anchor="middle" font-size="10" font-weight="700" fill="#fff">NEW</text>
  <text x="380" y="305" text-anchor="middle" font-size="11" font-style="italic" fill="#475569">Pod 2가 종료되면 ReplicaSet이 즉시 Pod 3을 띄워 다시 2개를 유지합니다.</text>
</svg>
</div>
...
ReplicaSet은 쿠버네티스에 별도로 존재하는 리소스이지만, 롤링 업데이트나 롤백 같은 배포 기능이 없습니다. 그래서 실무에서는 **ReplicaSet을 직접 만들지 않고 Deployment를 사용**합니다. Deployment의 **replicas 속성**을 통해 내부적으로 ReplicaSet을 자동으로 만들어 Pod 개수를 유지하고, 롤링 업데이트와 롤백까지 함께 제공합니다.
:::
...
```yaml [실습 3] ex10/deploy-ex02.yml. replicas 4와 롤링 업데이트 전략
apiVersion: apps/v1
kind: Deployment
metadata:
  name: nginx-replica
...
앞서 만든 `deploy-ex02.yml`에는 이 롤링 업데이트 동작을 정하는 `strategy` 블록이 들어 있습니다. 각 속성은 다음과 같습니다.
...
<div class="svg-figure">
<svg viewBox="0 0 820 256" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="롤링 업데이트 4단계: 새 Pod 4개가 뜨고 기존 Pod 4개가 사라지는 과정">
  <defs><marker id="ru-arr" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L0,6 L7,3 z" fill="#94a3b8"/></marker></defs>
  <text x="410" y="26" text-anchor="middle" font-size="14" font-weight="700" fill="#0f172a">롤링 업데이트 진행 — replicas 4 · maxSurge 4 · maxUnavailable 0</text>
  <rect x="30" y="44" width="160" height="158" rx="8" fill="#fff" stroke="#e2e8f0" stroke-width="1.4"/>
  <rect x="225" y="44" width="160" height="158" rx="8" fill="#fff" stroke="#4f46e5" stroke-width="1.6"/>
  <rect x="430" y="44" width="160" height="158" rx="8" fill="#fff" stroke="#e2e8f0" stroke-width="1.4"/>
  <rect x="630" y="44" width="160" height="158" rx="8" fill="#fff" stroke="#e2e8f0" stroke-width="1.4"/>
  <text x="110" y="66" text-anchor="middle" font-size="12.5" font-weight="700" fill="#334155">① 시작</text>
  <text x="305" y="66" text-anchor="middle" font-size="12.5" font-weight="700" fill="#4f46e5">② 새 버전 추가</text>
  <text x="510" y="66" text-anchor="middle" font-size="12.5" font-weight="700" fill="#334155">③ 기존 종료</text>
  <text x="710" y="66" text-anchor="middle" font-size="12.5" font-weight="700" fill="#334155">④ 완료</text>
  <text x="110" y="98" text-anchor="middle" font-size="10.5" font-weight="700" fill="#7b341e">v1.20</text>
  <circle cx="83" cy="116" r="8" fill="#ff7849"/><circle cx="103" cy="116" r="8" fill="#ff7849"/><circle cx="123" cy="116" r="8" fill="#ff7849"/><circle cx="143" cy="116" r="8" fill="#ff7849"/>
  <text x="110" y="150" text-anchor="middle" font-size="13" fill="#cbd5e1">—</text>
  <text x="110" y="184" text-anchor="middle" font-size="11" fill="#475569">v1.20 · 4개</text>
  <text x="305" y="98" text-anchor="middle" font-size="10.5" font-weight="700" fill="#7b341e">v1.20</text>
  <circle cx="278" cy="116" r="8" fill="#ff7849"/><circle cx="298" cy="116" r="8" fill="#ff7849"/><circle cx="318" cy="116" r="8" fill="#ff7849"/><circle cx="338" cy="116" r="8" fill="#ff7849"/>
  <text x="305" y="142" text-anchor="middle" font-size="10.5" font-weight="700" fill="#3730a3">v1.21</text>
  <circle cx="278" cy="160" r="8" fill="#4f46e5"/><circle cx="298" cy="160" r="8" fill="#4f46e5"/><circle cx="318" cy="160" r="8" fill="#4f46e5"/><circle cx="338" cy="160" r="8" fill="#4f46e5"/>
  <text x="305" y="190" text-anchor="middle" font-size="11" font-weight="700" fill="#4f46e5">총 8개 (일시 증가)</text>
  <text x="510" y="98" text-anchor="middle" font-size="10.5" font-weight="700" fill="#cbd5e1">v1.20</text>
  <circle cx="483" cy="116" r="8" fill="#eef1f5"/><circle cx="503" cy="116" r="8" fill="#eef1f5"/><circle cx="523" cy="116" r="8" fill="#eef1f5"/><circle cx="543" cy="116" r="8" fill="#eef1f5"/>
  <line x1="478" y1="111" x2="548" y2="121" stroke="#cbd5e1" stroke-width="1.4"/>
  <text x="510" y="142" text-anchor="middle" font-size="10.5" font-weight="700" fill="#3730a3">v1.21</text>
  <circle cx="483" cy="160" r="8" fill="#4f46e5"/><circle cx="503" cy="160" r="8" fill="#4f46e5"/><circle cx="523" cy="160" r="8" fill="#4f46e5"/><circle cx="543" cy="160" r="8" fill="#4f46e5"/>
  <text x="510" y="190" text-anchor="middle" font-size="11" fill="#475569">기존 4개 내려감</text>
  <text x="710" y="98" text-anchor="middle" font-size="10.5" font-weight="700" fill="#cbd5e1">v1.20</text>
  <text x="710" y="120" text-anchor="middle" font-size="13" fill="#cbd5e1">—</text>
  <text x="710" y="142" text-anchor="middle" font-size="10.5" font-weight="700" fill="#3730a3">v1.21</text>
  <circle cx="683" cy="160" r="8" fill="#4f46e5"/><circle cx="703" cy="160" r="8" fill="#4f46e5"/><circle cx="723" cy="160" r="8" fill="#4f46e5"/><circle cx="743" cy="160" r="8" fill="#4f46e5"/>
  <text x="710" y="184" text-anchor="middle" font-size="11" fill="#475569">v1.21 · 4개</text>
  <path d="M 192 128 L 222 128" fill="none" stroke="#94a3b8" stroke-width="1.4" marker-end="url(#ru-arr)"/>
  <path d="M 387 128 L 427 128" fill="none" stroke="#94a3b8" stroke-width="1.4" marker-end="url(#ru-arr)"/>
  <path d="M 592 128 L 627 128" fill="none" stroke="#94a3b8" stroke-width="1.4" marker-end="url(#ru-arr)"/>
  <text x="410" y="232" text-anchor="middle" font-size="11" fill="#475569"><tspan font-weight="700" fill="#4f46e5">maxSurge 4</tspan> → 새 Pod 4개를 먼저 띄우고, <tspan font-weight="700" fill="#7b341e">maxUnavailable 0</tspan> → 기존 4개를 그 뒤에 내려 서비스가 끊기지 않습니다</text>
</svg>
</div>

*그림 4-23. 롤링 업데이트 진행 - 새 Pod 4개를 띄운 뒤 기존 Pod 4개를 차례로 내립니다*

**maxSurge를 줄이면** 한 번에 띄울 새 Pod 수가 제한되어 천천히 교체되고, **maxUnavailable을 늘리면** 기존 Pod가 한 번에 더 많이 종료되는 것을 허용해 빠르게 교체할 수 있습니다. 이렇게 두 값을 조정해 원하는 배포 방식을 설정합니다.
...
<div class="terminal-log">
  ...
  <div class="tl-body">
    ...
    <div>nginx-replica-576bff5654-7gtrn   1/1     Running             0          7s</div>
    <div>nginx-replica-576bff5654-hkqwp   1/1     Running             0          7s</div>
