...
컨테이너가 무엇인지 알았으니 이제 Docker가 어떤 원리로 동작하는지 살펴보겠습니다. 그 출발점은 **가상화** 입니다.
...
![Docker의 큰 그림](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\chapters\images\fig-1-bp-0.png)
*그림 1-11: Docker의 흐름*
...
![Docker Desktop 실행 화면](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\chapters\images\chap01-14.png)
...
명령어를 실행하면 **컨테이너 ID** 가 출력되고 터미널은 입력 가능한 상태로 돌아옵니다.
...
![프로비저닝](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\chapters\images\chap02-provisining.png)
*그림 2-1: 수동 세팅과 프로비저닝*
...
![풀스택 애플리케이션 아키텍처](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\chapters\images\fig-1.png)
...
![Pod — 최소 실행 단위](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\k8s-step1.png)
...
![kubectl run hello-pod1 실행 결과](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\01_kubectl-run-hello-pod1.png)
...
![Pod 목록 조회](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\02_kubectl-get-pod.png)
*그림 3-12: Pod 목록 조회*
...
![Deployment → ReplicaSet → Pod](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\k8s-step2.png)
...
![Deployment와 Pod 생성 확인](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\03_kubectl-get-pod-deploy.png)
...
![Pod 제거 후 자동 재생성 확인](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\04_kubectl-delete-pod-all.png)
...
![replicas 설정으로 Pod 4개 생성](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\07_kubectl-get-pods-replicas.png)
...
![롤링 업데이트 진행 상황](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\06_kubectl-get-pods-w-rolling.png)
...
![Service → Pod](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\k8s-step3.png)
...
![Pod IP 변경 확인](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\08_pod-ip-change.png)
...
![Service 생성](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\10_kubectl-apply-service.png)
*그림 3-25: Service 생성*
...
![Pod 삭제 후 Service 접속](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\11_delete-pod-minikube-service.png)
...
![Ingress → Service → Pod](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\k8s-step4c.png)
...
![ConfigMap / Secret → Pod](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\k8s-step4a.png)
...
![Pod 환경 변수에 Secret 값 확인](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\13_secret-env.png)
...
![PV / PVC → Pod](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\k8s-step4b.png)
...
![실행 결과](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\chapters\images\chap03-58.png)
...
![실행 결과](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\chapters\images\chap03-59.png)
...
![실행 결과](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\chapters\images\chap03-62.png)
...
![ex08 풀스택 Kubernetes 아키텍처](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\chapters\images\fig-3-7.png)
...
![Namespace](C:\study\book\book-workflow\projects\특이점이-온-개발자-도커-쿠버네티스\assets\k8s-namespace.png)
