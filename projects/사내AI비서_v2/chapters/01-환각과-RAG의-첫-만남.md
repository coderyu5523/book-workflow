...
그런데 커넥트의 내부 규정집은 공개된 적이 없습니다. 이 외부인이 읽을 방법이 없었습니다.
...
이번 챕터의 목표는 이 흐름을 직접 만들어보는 것입니다. 지금은 더미 문서 3개짜리 간단한 버전으로 시작하겠습니다. 실제 PDF 파싱, 한국어 임베딩 모델 적용, DB 연동은 뒤 챕터에서 차례로 붙입니다.
