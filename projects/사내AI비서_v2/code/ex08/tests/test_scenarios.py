...
class TestEvalFramework(unittest.TestCase):
    ...
    def test_test_questions_file(self):
...
class TestDocumentParser(unittest.TestCase):
    ...
    def test_library_parse_missing_file(self):
...
class TestDocumentCapture(unittest.TestCase):
    ...
    def test_extract_metadata_existing_file(self):
    ...
    def test_captured_dir_structure(self):
...
class TestEvidencePipeline(unittest.TestCase):
    ...
    def test_unstructured_evidence(self):
        """비정형 질문에 대해 근거를 반환한다."""
        from tuning.evidence_pipeline import retrieve_with_evidence
