...
def capture_docx_images(docx_path):
...
def capture_xlsx_sheets(xlsx_path):
...
def _render_sheet_image(ws, stem, sheet_name, output_dir):
...
def run_capture_pipeline():
    ...
    console.rule("[bold blue]ex08 문서 캡처 + 인제스천 파이프라인[/bold blue]")
