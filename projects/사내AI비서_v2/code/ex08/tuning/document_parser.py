...
def parse_docx_library(docx_path):
...
def parse_xlsx_library(xlsx_path):
...
def _render_sheet_as_image(ws, sheet_name):
...
def run_parser_comparison():
    ...
    console.rule("[bold blue]ex08 문서 파싱 전략 비교[/bold blue]")
