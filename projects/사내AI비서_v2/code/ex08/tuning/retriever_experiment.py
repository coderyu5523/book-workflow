...
def create_chroma_retriever(k=5):
...
def run_metadata_filter_experiment(retriever, query):
    """메타데이터 필터링 실험을 실행합니다."""
    results = []
...
def run_all_retriever_experiments():
    """모든 Retriever 튜닝 실험을 실행합니다."""
    console.rule("[bold blue]ex08 Retriever 튜닝 실험[/bold blue]")
