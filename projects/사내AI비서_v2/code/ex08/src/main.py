...
def run_agent_cli(demo=False):
    """에이전트 CLI를 시작한다."""
    print_separator()
    print("사내 AI 비서 — ex08 RAG 튜닝")
    print_separator()
