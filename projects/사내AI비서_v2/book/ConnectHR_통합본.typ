...
#set page(width: 188mm, height: 254mm, margin: (top: 20mm, bottom: 28mm, left: 22mm, right: 17mm))
#set text(size: 10pt)
...
#show heading.where(level: 1): it => {
  ...
  block(
    ...
    sticky: true,
    {
      text(26pt, weight: "bold", fill: color-text)[#it.body]
      v(8pt)
...
#show heading.where(level: 2): it => {
  ...
  block(
    ...
    text(16pt, weight: "bold", fill: color-primary-dark)[#it.body]
  )
  v(6pt)
}
...
#show raw.where(block: false): it => {
  box(
    ...
    inset: (x: 4pt, y: 2pt),
    radius: 3pt,
    text(size: 8.5pt, fill: color-code-text, font: ("D2Coding", "RIDIBatang"))[#it]
  )
}
  ...
  block(
    ...
    radius: (right: 4pt),
    {
      ...
      if label == [] or label == none {
        ...
        text(size: 9pt)[#text(weight: "bold", fill: color-primary)[#label] #text(fill: rgb("#4b5563"))[#body]]
      }
    }
  )
}
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/사내AI비서_v2/assets/CH02/diagram/02_api-waiter.png", alt: [그림 2-1: API는 식당의 웨이터다. 손님(프론트엔드)과 주방(DB)을 연결한다.], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/사내AI비서_v2/assets/CH02/gemini/02_crud-menu.png", alt: [그림 2-2: API의 메뉴판. 네 가지 동작이면 거의 모든 데이터를 다룰 수 있다.], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/사내AI비서_v2/assets/CH02/gemini/02_erd-diagram.png", alt: [그림 2-3: 사내 시스템의 세 테이블. 직원을 중심으로 연차가 연결되고, 매출은 부서 단위로 독립 관리된다.], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/사내AI비서_v2/assets/CH03/gemini/03_document-pipeline.png", alt: [그림 3-1: 사내 문서를 벡터 DB에 넣기까지. 정리 없이 넣으면 검색 품질이 떨어진다.], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/사내AI비서_v2/assets/CH03/diagram/03_parser-flow.png", alt: [그림 3-2: 파서가 다양한 형식을 Markdown 텍스트로 통일한다. 그래야 청킹하고 검색할 수 있다.], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/사내AI비서_v2/assets/CH04/gemini/04_vectordb-pipeline.png", alt: [그림 4-1: 문서를 벡터 DB에 넣는 과정은 요리의 손질 → 다지기 → 양념 → 냉장고 정리와 같다.], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/사내AI비서_v2/assets/CH04/diagram/04_parser-select.png", alt: [그림 4-2: 파일 확장자에 따라 적절한 파서를 선택한다. 통합 함수 하나로 자동 분기.], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/사내AI비서_v2/assets/CH04/gemini/04_cosine-similarity.png", alt: [그림 4-4: 코사인 유사도의 각도에 따른 값의 변화], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/사내AI비서_v2/assets/CH05/gemini/05_sliding-window.png", alt: [그림 5-3: 메모장에 6번째 메모가 들어오면 가장 오래된 1번째가 빠진다. 항상 최근 5장만 유지.], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/사내AI비서_v2/assets/CH06/gemini/06_query-router.png", alt: [그림 6-1: 대부분의 질문은 1단계 키워드 매칭에서 끝난다. 모호할 때만 더 비싼 방법을 쓴다.], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/사내AI비서_v2/assets/CH06/diagram/06_react-flow.png", alt: [그림 6-2: 질문이 들어오면 QueryRouter가 분류하고, ReAct 에이전트가 필요한 도구를 순서대로 호출한다.], max-width: 0.6)
...
#auto-image("/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/사내AI비서_v2/assets/CH08/gemini/08_search-evolution.png", alt: [그림 8-1: 사서가 성장하는 과정. 가위로 자르던 사서가, 문단을 보고, 의미를 읽고, 두 가지 방법을 섞어 찾게 된다.], max-width: 0.6)
