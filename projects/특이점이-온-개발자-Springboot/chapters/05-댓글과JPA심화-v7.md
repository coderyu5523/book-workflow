...
오픈이는 인증 게시판에 이어 댓글 기능을 추가하기로 했습니다. 댓글을 저장하는 기능까지는 금방 만들었지만, 게시글을 조회하는 코드 앞에서 손이 멈췄습니다. 게시글에는 작성자가 있고, 댓글이 여러 개 달리고, 댓글마다 또 작성자가 있었습니다.

*게시글 하나 가져오는데 작성자, 댓글, 댓글 작성자까지 다 따로 조회해야 하나?*

오픈이는 선배를 찾아갔습니다.

**오픈이**: "선배님, 게시글에 댓글까지 붙으니까 데이터를 어떻게 가져와야 할지 막막하네요."
