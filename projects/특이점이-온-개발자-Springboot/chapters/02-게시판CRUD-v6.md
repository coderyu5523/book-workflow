...
- **REST API**로 게시글을 주소로 가리키고 HTTP 메서드로 구분해 요청과 응답을 주고받을 수 있습니다
- **JPA**로 자바 객체와 데이터베이스 테이블을 연결하고, **JPQL**로 원하는 조회를 작성할 수 있습니다
- **3계층 아키텍처**로 컨트롤러, 서비스, 리포지토리의 역할을 나눌 수 있습니다
- **영속성 컨텍스트**의 캐싱, 쓰기 지연, 더티체킹이 동작하는 과정을 이해할 수 있습니다
- **단위 테스트**로 리포지토리를 검증하고 게시판 CRUD를 완성할 수 있습니다
:::
