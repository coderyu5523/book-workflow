...
이제 게시판은 없는 게시글 요청에 404로 답하고, 요청으로 받을 값과 응답으로 내보낼 값은 DTO가 정합니다. 그런데 오픈이는 API를 테스트하다가 새로운 문제를 발견했습니다.

아무런 정보 없이 1번 게시글에 수정 요청을 보냈는데, 응답 창에 200이 돌아오며 제목과 내용이 변경되었습니다. 삭제 요청도 마찬가지였습니다.
