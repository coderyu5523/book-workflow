...
![Docker 실습 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH01/diagram/01_exercise-flow.png)
...
![Docker 이미지와 컨테이너의 관계](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH01/gemini/01_docker-image-container.png)
...
*[이미지: docker compose up 실행 — 이미지 빌드 과정]*

*[이미지: Spring Boot 서버가 8080 포트에서 시작된 로그]*

빌드와 실행이 끝나면 브라우저에서 `http://localhost:8080` 에 접속합니다.

*[이미지: localhost:8080 접속 결과 — hello world!. 텍스트가 표시된 브라우저 화면]*
...
*[이미지: Docker Desktop — spring-docker 컨테이너가 실행 중인 화면]*

자바 설치, 빌드 도구 설정, 포트 설정 — 이 모든 과정이 `docker compose up --build` 한 줄로 끝났습니다. 컨테이너를 내릴 때는 `docker compose down` 을 실행합니다.

*[이미지: docker compose down 실행 결과 — 컨테이너와 네트워크가 정리된 화면]*

### 1.4 Docker 전체 흐름

![Docker 전체 워크플로우](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH01/gemini/02_docker-workflow.png)
...
![OAuth 실습 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/diagram/02_exercise-flow.png)
...
![카카오 디벨로퍼 앱 설정 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/terminal/01_kakao-developer-app.png)
...
![인가 코드 발급 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/gemini/02a_oauth-authorization-code-grant.png)

*그림 2-2a: 인가 코드 발급 — 사용자가 카카오에 동의하면 인가 코드가 서버로 전달된다*

![토큰 교환 + 사용자 정보 조회 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/gemini/02b_oauth-token-exchange.png)
...
![카카오 동의 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/terminal/03_kakao-consent-screen.png)
...
![Access Token 교환 결과](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/terminal/04_access-token-exchange.png)
...
![OIDC ID Token 발급 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/gemini/05a_oidc-id-token-issue.png)

*그림 2-5a: ID Token 발급 — scope에 openid를 추가하면 ID Token이 함께 응답된다*

![JWKS 공개키 검증 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/gemini/05b_oidc-jwks-verification.png)
...
![OIDC JWT 검증 성공 후 사용자 정보](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH02/terminal/06_oidc-jwt-verification.png)
...
![Redis 세션 공유 아키텍처](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/diagram/03_architecture.png)
...
![Client에서 Nginx를 거쳐 Spring A, Spring B로 분기되고 두 서버 모두 Redis를 바라보는 구조](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/01_architecture-overview.png)
...
![서버 A와 B가 각각 독립적으로 Redis를 바라보는 구조](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/02_server-ab-role.png)
...
![세션 공유 코드 설명](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/04_session-share-code.png)
...
![Nginx 경로 기반 라우팅 설명](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/03_nginx-routing.png)
...
![docker-compose 구성 설명](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/05_docker-compose-structure.png)
...
![/app1 접속 시 count=1](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/06_app1-count1.png)
...
![/app2 접속 시 count=2](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/07_app2-count2.png)
...
![다시 /app1 접속 시 count=3](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/08_app1-count3.png)

*그림 3-8: 다시 /app1 접속 -- count가 3으로 이어진다. 서버가 바뀌어도 세션이 유지된다*

count가 3입니다. 서버 A -> 서버 B -> 서버 A로 요청이 오갔지만 세션이 끊기지 않았습니다.

![왜 Redis 세션 공유가 필요한가 정리](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH03/terminal/09_session-share-summary.png)
...
**나**: "이미지를 서버에 보내려면 어떻게 해?"

**동료**: "Multipart로 보내거나 Base64로 인코딩해서 보내거나."
...
**나**: "아 그러면 프론트에서 이미지를 텍스트로 바꿔서 JSON으로 보내면 되는 거네."

**동료**: "맞아. 서버에서 다시 파일로 복원해서 저장하면 끝이야."
...
![Base64 업로드 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/diagram/04_upload-flow.png)
...
![Postman에서 Base64 문자열을 JSON으로 전송하면 Spring이 디코딩하여 파일로 저장하고 DB에 기록한 뒤 URL을 반환하는 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/12_upload-flow-diagram.png)
...
![ImageEntity 엔티티 구조 설명](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/14_entity-design.png)
...
![요청 DTO와 응답 DTO 설명](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/15_dto-design.png)
...
![업로드 API 내부 흐름 설명](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/16_upload-api-flow.png)
...
![Base64 인코딩 사이트에서 이미지를 문자열로 변환하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/02_base64-encode-site.png)

*그림 4-5: Base64 인코딩 -- 온라인 변환 사이트에서 이미지를 업로드하면 Base64 문자열이 생성된다*

![Base64 인코딩 결과 문자열](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/03_base64-encode-upload.png)

*그림 4-6: 인코딩 결과 -- 이미지가 긴 텍스트 문자열로 변환된다*

![Base64 문자열 복사](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/04_base64-encode-result.png)

*그림 4-7: 문자열 복사 -- 이 문자열을 Postman의 JSON body에 붙여넣는다*

변환된 문자열을 Postman에서 JSON에 담아 보냅니다.

![Postman에서 upload 요청을 보내는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/05_postman-upload-request.png)

*그림 4-8: Postman 업로드 요청 -- fileName과 fileData를 JSON으로 전송한다*

![Postman 요청 body에 Base64 문자열이 들어간 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/06_postman-upload-send.png)

*그림 4-9: 요청 Body -- fileData에 Base64 문자열이 담겨 있다*

![Postman 업로드 응답 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/07_postman-upload-response.png)

*그림 4-10: 업로드 응답 -- id, uuid, fileName, url, createdAt이 반환된다*

응답에 `url` 이 `/uploads/UUID.png` 형태로 돌아옵니다. 이 경로로 브라우저에서 이미지를 볼 수 있습니다.

![브라우저에서 업로드된 이미지를 확인하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/08_browser-image-check.png)
...
![정적 리소스 매핑 설명](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/17_static-resource-mapping.png)
...
![Postman으로 단건 조회하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/09_postman-get-by-id.png)

*그림 4-13: 단건 조회 -- id로 특정 이미지 정보를 조회한다*

![Postman으로 목록 조회하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/10_postman-get-list.png)

*그림 4-14: 목록 조회 -- 저장된 모든 이미지 목록이 반환된다*

![브라우저에서 이미지를 확인하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/11_browser-image-view.png)

*그림 4-15: 브라우저 이미지 확인 -- 정적 리소스 매핑을 통해 이미지가 브라우저에 표시된다*

![정적 리소스로 제공되는 이미지](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/18_browser-static-image.png)
...
![React에서 이미지를 업로드하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/19_react-upload.png)

*그림 4-17: React 이미지 업로드 -- 파일을 선택하면 Base64로 변환되어 서버에 전송된다*

![React에서 이미지 목록을 보는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/20_react-list.png)

*그림 4-18: React 이미지 목록 -- 서버에 저장된 이미지들이 리스트로 표시된다*

![React에서 이미지 상세를 보는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH04/terminal/21_react-detail.png)
...
![Presigned URL 실습 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/diagram/05_exercise-flow.png)
...
![Client가 Spring에 Presigned URL을 요청하고 받은 URL로 S3에 직접 업로드하는 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/gemini/05_upload-flow.png)

*그림 5-1a: 업로드 단계 -- 서버는 URL만 발급하고 파일은 클라이언트가 S3에 직접 올린다*

![S3에 이미지가 올라오면 Lambda가 리사이즈하고 Client가 Spring에 완료를 알리는 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/gemini/05_resize-flow.png)
...
![환경 변수 설정 파일](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/07_env-file.png)
...
![Postman에서 presigned URL 발급을 요청하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/08_postman-presign-request.png)

*그림 5-3: Presigned URL 요청 -- fileName과 contentType을 JSON으로 보낸다*

![Postman에서 presigned URL 응답을 확인하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/09_postman-presign-response.png)
...
![Postman에서 S3 PUT 요청 헤더를 설정하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/10_postman-s3-put-header.png)

*그림 5-5: S3 PUT 헤더 -- Content-Type을 presigned 요청과 동일하게 맞춘다*

![Postman에서 S3에 바이너리 파일을 첨부하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/11_postman-s3-put-binary.png)

*그림 5-6: S3 PUT Body -- Binary 탭에서 이미지 파일을 직접 선택한다*

![Postman에서 S3 PUT 응답 200을 확인하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/12_postman-s3-put-response.png)

*그림 5-7: S3 업로드 성공 -- 200 OK가 반환되면 S3에 파일이 올라간 것이다*

![AWS 콘솔에서 S3 original 폴더에 파일이 올라간 것을 확인하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/13_s3-original-confirm.png)

*그림 5-8: S3 확인 -- original 폴더에 업로드한 이미지가 저장되어 있다*

![S3에 저장된 원본 이미지를 미리보기하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/14_s3-original-image.png)
...
![AWS Lambda 함수를 생성하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/05_lambda-create.png)
...
![Lambda에 Layer를 추가하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/16_lambda-layer-add.png)

*그림 5-11: Pillow Layer 추가 -- Lambda에 이미지 처리 라이브러리를 Layer로 추가한다*

![Pillow Layer ARN을 입력하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/17_lambda-layer-arn.png)

*그림 5-12: Layer ARN -- Pillow Layer의 ARN을 지정한다*

![Layer가 추가된 것을 확인하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/18_lambda-layer-confirm.png)

*그림 5-13: Layer 확인 -- Pillow Layer가 정상적으로 추가되었다*

S3 이벤트 트리거를 설정합니다. `original/` 폴더에 파일이 올라오면 Lambda가 자동으로 실행되도록 연결합니다.

![Lambda에 S3 트리거를 설정하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/06_lambda-trigger.png)

*그림 5-14: S3 트리거 설정 -- original/ prefix로 ObjectCreated 이벤트를 연결한다*

![Lambda 코드를 배포하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/15_lambda-code-deploy.png)

*그림 5-15: Lambda 배포 -- 코드를 작성하고 Deploy 버튼으로 배포한다*

![Lambda 테스트 실행 결과](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/19_lambda-test.png)

*그림 5-16: Lambda 테스트 -- 테스트 이벤트로 함수가 정상 실행되는지 확인한다*

![S3 resized 폴더에 리사이즈된 이미지가 저장된 것을 확인하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/20_s3-resized-confirm.png)
...
![Postman에서 /complete 요청을 보내는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/21_postman-complete-request.png)

*그림 5-18: /complete 요청 -- originalKey를 JSON으로 보낸다*

![Postman에서 /complete 응답을 확인하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/22_postman-complete-response.png)

*그림 5-19: /complete 응답 -- originalUrl과 resizedUrl이 모두 저장되어 반환된다*

![H2 콘솔에서 DB에 저장된 데이터를 확인하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/23_h2-console-confirm.png)
...
![Postman에서 이미지 목록을 조회하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/24_postman-list-response.png)

*그림 5-21: 목록 조회 -- 저장된 모든 이미지의 원본 URL과 리사이즈 URL이 반환된다*

![Postman에서 이미지 상세를 조회하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/25_postman-detail-response.png)
...
![AWS S3 버킷 생성 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/01_aws-s3-bucket.png)

*그림 5-23: S3 버킷 생성 -- 리전을 선택하고 버킷 이름을 지정한다*

![S3 버킷 내 original, resized 폴더 구조](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/02_s3-folder-structure.png)
...
![IAM 사용자 생성 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/03_iam-user-create.png)

*그림 5-25: IAM 사용자 생성 -- S3 접근용 사용자를 만든다*

![IAM 액세스 키 생성 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/04_iam-access-key.png)
...
![S3 CORS 설정 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH05/terminal/26_s3-cors-setting.png)
...
![실시간 통신 실습 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/diagram/06_exercise-flow.png)
...
![Polling, SSE, WebSocket 세 방식의 통신 방향 비교](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/gemini/06_communication-compare.png)
...
![DevTools Network 탭에서 2초마다 /chats 요청이 반복되는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/01_polling-devtools.png)
...
![DevTools에서 SSE 연결 요청을 확인하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/02_sse-connect.png)

*그림 6-3: SSE 연결 -- /chats/connect 요청이 한 번만 나가고 연결이 유지된다*

![SSE connect 이벤트가 수신된 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/03_sse-connected-event.png)

*그림 6-4: connect 이벤트 -- 연결 즉시 서버가 "connected" 메시지를 보내온다*

![SSE chat 이벤트로 새 메시지가 수신된 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/04_sse-chat-event.png)

*그림 6-5: chat 이벤트 -- 다른 사용자가 채팅을 보내면 서버가 자동으로 밀어준다*

![브라우저 두 개에서 실시간으로 채팅이 동기화되는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/05_sse-realtime-ui.png)
...
![DevTools에서 WebSocket 연결을 확인하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/06_ws-devtools.png)

*그림 6-7: WebSocket 연결 -- /ws 엔드포인트로 한 번 연결되면 끊기지 않는다*

![STOMP SUBSCRIBE 프레임을 확인하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/07_ws-subscribe.png)

*그림 6-8: STOMP 구독 -- /topic/chats를 구독하면 서버가 보내는 메시지를 받을 준비가 된다*

![WebSocket으로 메시지를 보내고 받는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH06/terminal/08_ws-send-receive.png)
...
![HLS 실습 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/diagram/07_exercise-flow.png)
...
![업로드부터 브라우저 재생까지의 HLS 스트리밍 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/gemini/07_hls-flow.png)
...
![Postman에서 영상 업로드 후 HLS 변환 완료 응답을 받는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/terminal/01_postman-upload.png)
...
![HLS 변환 후 생성된 m3u8과 ts 파일 목록](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/terminal/02_hls-files-generated.png)
...
![Postman에서 m3u8 엔드포인트 응답을 확인하는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/terminal/03_postman-m3u8-check.png)

*그림 7-4: m3u8 엔드포인트 확인 -- 재생 목록이 정상적으로 반환된다*

720p와 1080p의 m3u8 응답입니다.

![720p m3u8 응답 내용](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/terminal/04_m3u8-720p-response.png)

*그림 7-5: 720p m3u8 응답 -- ts 조각 파일 목록과 재생 시간이 기록되어 있다*

![1080p m3u8 응답 내용](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/terminal/05_m3u8-1080p-response.png)

*그림 7-6: 1080p m3u8 응답 -- 같은 구조지만 해상도가 다르다*

브라우저에서 실제로 재생하면서 DevTools Network 탭을 열어 봅니다.

![브라우저에서 HLS 영상이 재생되며 DevTools에 ts 파일 요청이 나타나는 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH07/terminal/06_browser-player-devtools.png)
...
![ES 실습 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/diagram/08_exercise-flow.png)
...
![역인덱스 구조도 — 단어에서 문서로의 매핑](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/gemini/08_inverted-index.png)
...
![Docker Compose 실행 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/01_docker-compose-up.png)

*그림 8-1: docker-compose up -- Elasticsearch, Kibana, Spring Boot 앱이 함께 올라간다*

![ES 9200 응답 확인](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/02_es-health-check.png)
...
![Postman 데이터 저장 요청](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/03_postman-bulk-save.png)

*그림 8-3: Postman으로 데이터 저장 -- 요청이 성공하면 저장된 Document가 응답으로 온다*

![H2 DB 데이터 확인](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/04_h2-data-confirm.png)
...
![Postman 정상 검색](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/11_postman-normal-search.png)
...
![Kibana 메인 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/05_kibana-home.png)

*그림 8-6: Kibana 메인 화면 -- 왼쪽 메뉴에서 Dev Tools를 찾는다*

![Kibana Dev Tools 검색](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/06_kibana-devtools-open.png)

*그림 8-7: Dev Tools 진입 -- 검색 쿼리를 직접 실행할 수 있는 콘솔이 열린다*

![Dev Tools 콘솔 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/07_kibana-devtools-console.png)
...
![Kibana Fuzzy 검색 결과](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/10_kibana-fuzzy-search.png)

*그림 8-9: Kibana Fuzzy 검색 -- "갈럭시"로 검색해도 "갤럭시" 문서가 나온다*

Kibana에서 직접 문서를 삽입할 수도 있습니다.

![Kibana 문서 삽입](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/08_kibana-insert-doc.png)
...
![Kibana 삽입 후 H2 미반영](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/09_h2-no-kibana-insert.png)

*그림 8-11: H2 확인 -- Kibana에서 넣은 데이터는 RDB에 없다*

Postman에서 오타 검색도 확인합니다.

![Postman 오타 검색](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH08/terminal/12_postman-fuzzy-search.png)
...
![RabbitMQ 실습 흐름](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/diagram/09_exercise-flow.png)
...
![GitHub에서 Consumer까지의 RabbitMQ 전체 흐름도](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/gemini/09_rabbitmq-flow.png)
...
![RabbitMQ 로그인 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/03_rabbitmq-login.png)

*그림 9-1: RabbitMQ 관리 콘솔 로그인 화면*

로그인하면 관리 콘솔 메인 화면이 나옵니다.

![RabbitMQ 관리 콘솔 메인](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/01_rabbitmq-management-ui.png)
...
![config-readme 레포 생성](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/02_github-config-readme-repo.png)
...
![Producer 서버 실행](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/06_producer-bootrun.png)

*그림 9-4: Producer 서버 실행 -- 60초마다 GitHub을 폴링한다*

GitHub에서 README를 수정하고 커밋합니다.

![GitHub README 수정](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/07_github-readme-edit.png)

*그림 9-5: GitHub에서 README 수정*

Producer 로그에서 변경 감지를 확인합니다.

![Producer 변경 감지 로그](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/08_producer-detect-log.png)
...
![전체 서버 실행 상태](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/13_all-servers-running.png)

*그림 9-7: Docker, Producer, Consumer 세 서버가 모두 실행 중이다*

RabbitMQ 관리 콘솔에서 Exchange 탭을 확인합니다.

![Exchanges 탭 상태](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/04_exchanges-tab.png)

*그림 9-8: Exchanges 탭 -- Producer가 등록한 github.events Exchange가 보인다*

Exchange 상세에서 Binding 정보를 확인합니다.

![Exchange 상세](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/09_exchange-detail.png)

*그림 9-9: Exchange 상세 -- repo-updates Queue에 readme.changed Routing Key로 바인딩되어 있다*

Queue 상세에서 메시지 수와 상태를 확인합니다.

![Queue 상세](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/10_queue-detail.png)

*그림 9-10: Queue 상세 -- repo-updates Queue의 메시지 수와 소비 상태가 보인다*

Binding 정보도 확인합니다. Exchange에서 Queue로의 연결 규칙입니다.

![Binding 상세](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/11_binding-detail.png)

*그림 9-11: Binding 확인 -- readme.changed Routing Key로 바인딩되어 있다*

이제 GitHub에서 README를 수정하고 커밋합니다.

![GitHub README 커밋](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/14_github-readme-commit.png)

*그림 9-12: GitHub에서 README를 수정하고 커밋한다*

Producer가 변경을 감지합니다.

![Producer 폴링 감지 로그](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/15_producer-polling-log.png)

*그림 9-13: Producer가 SHA 변경을 감지하고 메시지를 발행한다*

Consumer가 메시지를 수신합니다.

![Consumer 메시지 수신 로그](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/16_consumer-receive-log.png)

*그림 9-14: Consumer가 메시지를 수신하고 파일 반영을 시작한다*

로컬 README 파일이 자동으로 업데이트됩니다.

![Consumer README 자동 업데이트](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/17_consumer-readme-updated.png)

*그림 9-15: 로컬 README 파일이 GitHub의 내용으로 자동 업데이트되었다*

백업 파일도 생성되었는지 확인합니다.

![백업 파일 확인](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/18_backup-file-confirm.png)

*그림 9-16: 이전 내용이 백업 파일로 저장되어 있다*

관리 콘솔에서 Queue에 들어온 메시지 내용을 직접 확인할 수도 있습니다. Queue 상세 화면에서 Get Messages를 클릭합니다.

![Queue 메시지 payload 확인](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH09/terminal/12_get-messages-payload.png)
