...
**동료**: "그러면 반영하는 서버가 내려가 있으면 어떻게 돼?"

**나**: "요청이 실패하겠지."

**동료**: "실패한 건 누가 다시 보내? 감지 서버가 재시도 로직까지 갖고 있어야 해. 반영 서버가 두 대로 늘어나면? 셋으로 늘어나면?"
...
**동료**: "메시지 큐를 쓰면 보내는 쪽은 큐에 넣기만 하면 돼. 받는 쪽이 죽어 있어도 메시지는 큐에 남아 있고, 살아나면 그때 가져가."
