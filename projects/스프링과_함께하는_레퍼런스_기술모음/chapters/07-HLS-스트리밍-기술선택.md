...
**나**: "영상이면 지난번에 만든 WebSocket으로 스트리밍하면 되지 않나요?"
...
**동료**: "그거 통째로 보내면 안 돼. 잘게 쪼개서 보내야 해."

**나**: "쪼갠다고?"

**동료**: "유튜브 생각해 봐. 영상 틀면 바로 재생되잖아. 전체를 다 받아서 트는 게 아니야."
...
**동료**: "이삿짐을 상자로 나눠서 번호 매기는 거랑 똑같아. 목록표 한 장이랑 상자 여러 개."

(목록표가 m3u8이고 상자가 ts 파일이구나.)

**나**: "그러면 영상을 쪼개는 건 누가 해?"

**동료**: "FFmpeg이라는 도구가 해. 영상을 넣으면 알아서 잘라줘."
