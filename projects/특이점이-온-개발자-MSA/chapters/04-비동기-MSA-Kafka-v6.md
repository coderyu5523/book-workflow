...
<div class="svg-figure">
<svg viewBox="0 0 1180 286" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="직접 발행의 문제: 주문은 DB에 저장됐는데 Kafka 발행이 실패하면 이벤트가 유실된다">
  <defs>
    <marker id="ob1-ok" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#4f46e5"/></marker>
    <marker id="ob1-bad" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#94a3b8"/></marker>
  </defs>
  <text x="590" y="36" text-anchor="middle" font-size="23" font-weight="700" fill="#0f172a">주문은 DB에 저장됐는데 Kafka 발행이 실패하면, 이벤트는 사라진다</text>
  <g transform="translate(70 118)">
    <rect x="0" y="0" width="150" height="92" rx="8" fill="#fff" stroke="#4f46e5" stroke-width="2"/>
    <line x1="0" y1="31" x2="150" y2="31" stroke="#4f46e5" stroke-width="1.2"/>
    <line x1="0" y1="62" x2="150" y2="62" stroke="#4f46e5" stroke-width="1.2"/>
    <circle cx="18" cy="15" r="3.2" fill="#4f46e5"/><circle cx="18" cy="46" r="3.2" fill="#4f46e5"/><circle cx="18" cy="77" r="3.2" fill="#4f46e5"/>
  </g>
  <text x="145" y="234" text-anchor="middle" font-size="20" font-weight="700" fill="#3730a3">주문 서비스</text>
  <line x1="220" y1="150" x2="466" y2="112" stroke="#4f46e5" stroke-width="2.4" marker-end="url(#ob1-ok)"/>
  <text x="338" y="112" text-anchor="middle" font-size="16" font-weight="700" fill="#4f46e5">주문 저장 (성공)</text>
  <rect x="470" y="78" width="200" height="74" rx="6" fill="#fff" stroke="#4f46e5" stroke-width="2"/>
  <text x="570" y="108" text-anchor="middle" font-size="19" font-weight="700" fill="#3730a3">주문 DB</text>
  <text x="570" y="132" text-anchor="middle" font-size="15" fill="#64748b">order_tb · 주문 저장됨</text>
  <line x1="220" y1="186" x2="466" y2="232" stroke="#94a3b8" stroke-width="2.4" stroke-dasharray="6,4" marker-end="url(#ob1-bad)"/>
  <text x="338" y="240" text-anchor="middle" font-size="16" font-weight="700" fill="#64748b">이벤트 발행 실패</text>
  <g stroke="#94a3b8" stroke-width="2.6"><line x1="332" y1="200" x2="348" y2="216"/><line x1="348" y1="200" x2="332" y2="216"/></g>
  <rect x="470" y="200" width="200" height="74" rx="6" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="2"/>
  <text x="570" y="230" text-anchor="middle" font-size="19" font-weight="700" fill="#94a3b8">Kafka</text>
  <text x="570" y="254" text-anchor="middle" font-size="15" fill="#94a3b8">이벤트 없음</text>
  <line x1="670" y1="237" x2="876" y2="224" stroke="#94a3b8" stroke-width="2.4" stroke-dasharray="6,4" marker-end="url(#ob1-bad)"/>
  <text x="772" y="200" text-anchor="middle" font-size="32" font-weight="700" fill="#94a3b8">?</text>
  <rect x="880" y="190" width="212" height="66" rx="6" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="2"/>
  <text x="986" y="218" text-anchor="middle" font-size="18" font-weight="700" fill="#94a3b8">오케스트레이터</text>
  <text x="986" y="240" text-anchor="middle" font-size="13" fill="#94a3b8">주문 생성 이벤트 못 받음</text>
</svg>
</div>
...
<div class="svg-figure">
<svg viewBox="0 0 1180 374" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Outbox 패턴 해결 흐름: 주문과 이벤트를 한 트랜잭션으로 저장하고, 발송기가 outbox를 폴링해 Kafka로 발행한다">
  <defs>
    <marker id="ob2-i" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#1e293b"/></marker>
    <marker id="ob2-k" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#1e293b"/></marker>
  </defs>
  <text x="590" y="34" text-anchor="middle" font-size="23" font-weight="700" fill="#0f172a">Outbox 패턴 — DB에 먼저 안전하게 적고, 발송기가 Kafka로 옮긴다</text>
  <g transform="translate(34 160)">
    <rect x="0" y="0" width="140" height="100" rx="8" fill="#fff" stroke="#4f46e5" stroke-width="2"/>
    <line x1="0" y1="33" x2="140" y2="33" stroke="#4f46e5" stroke-width="1.2"/>
    <line x1="0" y1="66" x2="140" y2="66" stroke="#4f46e5" stroke-width="1.2"/>
    <circle cx="18" cy="16" r="3.2" fill="#4f46e5"/><circle cx="18" cy="49" r="3.2" fill="#4f46e5"/><circle cx="18" cy="82" r="3.2" fill="#4f46e5"/>
  </g>
  <text x="104" y="284" text-anchor="middle" font-size="19" font-weight="700" fill="#3730a3">주문 서비스</text>
  <line x1="174" y1="210" x2="282" y2="210" stroke="#1e293b" stroke-width="2.6" marker-end="url(#ob2-i)"/>
  <text x="228" y="192" text-anchor="middle" font-size="16" font-weight="700" fill="#4f46e5">1. 함께 저장</text>
  <rect x="284" y="105" width="266" height="210" rx="6" fill="#fff" stroke="#4f46e5" stroke-width="2.4"/>
  <rect x="284" y="105" width="266" height="32" fill="#4f46e5"/>
  <text x="417" y="128" text-anchor="middle" font-size="18" font-weight="700" fill="#fff">주문 DB</text>
  <rect x="298" y="150" width="238" height="150" rx="6" fill="none" stroke="#4f46e5" stroke-width="1.3" stroke-dasharray="5,3"/>
  <rect x="352" y="141" width="130" height="22" rx="11" fill="#4f46e5"/>
  <text x="417" y="157" text-anchor="middle" font-size="14" font-weight="700" fill="#fff">한 트랜잭션</text>
  <rect x="312" y="166" width="210" height="56" rx="5" fill="#fff" stroke="#4f46e5" stroke-width="1.6"/>
  <text x="417" y="189" text-anchor="middle" font-size="18" font-weight="700" fill="#3730a3">order_tb</text>
  <text x="417" y="210" text-anchor="middle" font-size="14" fill="#64748b">주문 데이터</text>
  <rect x="312" y="230" width="210" height="56" rx="5" fill="#fff" stroke="#4f46e5" stroke-width="2.6"/>
  <text x="417" y="253" text-anchor="middle" font-size="18" font-weight="700" fill="#3730a3">outbox</text>
  <text x="417" y="274" text-anchor="middle" font-size="14" fill="#64748b">보낼 이벤트</text>
  <line x1="552" y1="196" x2="664" y2="196" stroke="#1e293b" stroke-width="2.4" stroke-dasharray="6,4" marker-end="url(#ob2-i)"/>
  <text x="608" y="182" text-anchor="middle" font-size="14" font-weight="700" fill="#4f46e5">2. 정보 확인</text>
  <line x1="664" y1="228" x2="552" y2="228" stroke="#1e293b" stroke-width="2.4" stroke-dasharray="6,4" marker-end="url(#ob2-i)"/>
  <text x="608" y="251" text-anchor="middle" font-size="14" font-weight="700" fill="#4f46e5">4. 정보 업데이트</text>
  <rect x="666" y="160" width="150" height="100" rx="8" fill="#fff" stroke="#4f46e5" stroke-width="2"/>
  <text x="741" y="216" text-anchor="middle" font-size="19" font-weight="700" fill="#3730a3">발송기</text>
  <line x1="816" y1="210" x2="928" y2="210" stroke="#1e293b" stroke-width="2.6" marker-end="url(#ob2-k)"/>
  <text x="872" y="192" text-anchor="middle" font-size="16" font-weight="700" fill="#9a3412">3. 발행</text>
  <rect x="930" y="150" width="210" height="150" rx="6" fill="#fff4ed" stroke="#ff7849" stroke-width="2.4"/>
  <rect x="930" y="150" width="210" height="32" fill="#ff7849"/>
  <text x="1035" y="173" text-anchor="middle" font-size="18" font-weight="700" fill="#fff">KAFKA</text>
  <rect x="950" y="200" width="170" height="70" rx="5" fill="#fff" stroke="#ff7849" stroke-width="1.6"/>
  <text x="1035" y="238" text-anchor="middle" font-size="17" font-weight="700" fill="#9a3412">order-created</text>
  <text x="590" y="356" text-anchor="middle" font-size="16" fill="#475569" font-style="italic">Kafka가 잠시 멈춰도 이벤트는 outbox에 남아, 발송기가 다음 차례에 다시 발행합니다 (유실 없음)</text>
</svg>
</div>
...
Outbox 패턴은 이벤트 유실을 막아주지만, 중복 발송까지 막지는 못합니다. 발송기가 이벤트를 보낸 직후 완료 처리를 하기 전에 멈추면, 다음 차례에 같은 이벤트를 또 보내기 때문입니다. 그래서 이벤트를 받는 쪽은 똑같은 요청을 여러 번 받아도 한 번만 처리한 것과 같은 결과를 내도록 방어해야 합니다. 이러한 성질을 **멱등성**이라고 합니다. 실무에서는 보통 이미 처리한 이벤트 ID를 기록해 두고, 같은 ID가 다시 들어오면 건너뛰는 방식으로 구현합니다.
