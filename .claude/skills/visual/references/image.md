...
| 이미지 유형 | 스타일 | 예시 |
|------------|--------|------|
| 흐름도, 순서도, 단일 개념 | **Base** (라인아트) | 파이프라인 흐름, 아키텍처 구조, 단계별 진행 |
| 비교(A vs B), 구조 분해, 표 포함 | **Infographic Variant** | OCR vs Vision LLM, Percentile 전략 비교, 청킹 방식 비교 |
...
- **복잡도 제한**: 화살표 5개 초과 시 2개 다이어그램으로 분리하라. Mermaid의 "노드 최대 7개" 규칙과 동일한 정신 → why-log.md#2026-03-15-4
