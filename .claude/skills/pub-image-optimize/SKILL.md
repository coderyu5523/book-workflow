...
## 2열(dual-image) 레이아웃 기준

이미지 2개를 나란히 배치하는 2열 레이아웃 적용 기준.

### 적용 조건

- 비교/대조 목적의 이미지 2개 (before/after, A vs B)
- 비슷한 크기의 이미지 쌍
...
````markdown
```{=typst}
#dual-image("assets/CH01/01_before.png", "assets/CH01/01_after.png", caption1: "변경 전", caption2: "변경 후")
```
````
